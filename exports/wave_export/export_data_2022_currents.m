...
loadnames={'V_x','V_y','W','SAL','TEMP'};
short_names={'Vx','Vy','W','SAL','TEMP'};
long_names={'Vx','Vy','W','SAL','TEMP'};
units ={'m/s','m/s','m/s','PSU','degrees'};
...
save('extracted_for_Currents.mat','output','-mat','-v7.3');
