...
loadnames={'WQ_DIAG_NCS_D_TAUB','D','SAL','TEMP','WQ_DIAG_TOT_LIGHT','WQ_DIAG_TOT_PAR','V_x','V_y'};
short_names={'TAUB','Depth','SAL','TEMP','LIGHT','PAR','Vx','Vy'};
long_names={'bottom stress', 'water depth','salinity','temperature',...
    'light','Photosynthetically active radiation','Vx','Vy'};
units ={'N/m2','m', 'PSU','degree C','W/m2','W/m2','m/s','m/s'};
...
save('extracted_for_Giulia.mat','output','-mat','-v7.3');
