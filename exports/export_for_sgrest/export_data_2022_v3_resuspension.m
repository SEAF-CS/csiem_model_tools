...
ncfile(1).name='W:\csiem\Model\TFV\Results_2022_B009\csiem_v1_B009_20220101_20221231_WQ_WQ.nc';
...
loadnames={'WQ_NCS_SS1','WQ_DIAG_NCS_SS1_VVEL','WQ_DIAG_NCS_SS1_SET','WQ_DIAG_NCS_SS_SED','WQ_DIAG_NCS_TAU_0','WQ_DIAG_NCS_EPSILON','WQ_DIAG_NCS_SET','WQ_DIAG_NCS_SWI','WQ_DIAG_NCS_SWI_DZ','WQ_DIAG_NCS_RESUS','WQ_DIAG_NCS_D_TAUB'};
short_names={'SS1','SS1VEL','SS1SET','SSSED','TAU0','NCSEPS','NCSSET','NCSSWI','SWIDZ','NCSRES','TAUB'};
long_names={'SS1','SS1VEL','SS1SET','SSSED','TAU0','NCSEPS','NCSSET','NCSSWI','SWIDZ','NCSRES','TAUB'};
units ={'mg/L','m/s','mg/m2/s','mg/m3','N/m2','mg/m2/s','mg/m2/s','mg/m2/s','m','mg/m2/s','N/m2'};
...
save('extracted_for_Giulia_v3.mat','output','-mat','-v7.3');

else
    load extracted_for_Giulia_v3.mat;
end
