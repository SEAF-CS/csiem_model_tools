...
ncfile(1).name='W:\csiem\Model\TFV\Results_2011_OASIM\csiem_v1_A001_20101001_20120101_WQ_lowRes_MACT1_newBIN_WQ.nc';
...
save('extracted_OASIM_2011.mat','output','-mat','-v7.3');

else
    load extracted_OASIM_2011.mat;
end
