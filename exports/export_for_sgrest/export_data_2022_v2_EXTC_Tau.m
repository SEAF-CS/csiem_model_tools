...
loadnames={'WQ_DIAG_NCS_D_TAUB','SAL','TEMP','WQ_DIAG_TOT_LIGHT','WQ_DIAG_TOT_PAR','V_x','V_y','WQ_DIAG_TOT_EXTC','TAUC','TAUW'};
short_names={'TAUB','SAL','TEMP','LIGHT','PAR','Vx','Vy','EXTC','TAUC','TAUW'};
long_names={'bottom stress', 'salinity','temperature',...
    'light','Photosynthetically active radiation','Vx','Vy','EXTC','TAUC','TAUW'};
...
save('extracted_for_Giulia_v2.mat','output','-mat','-v7.3');
