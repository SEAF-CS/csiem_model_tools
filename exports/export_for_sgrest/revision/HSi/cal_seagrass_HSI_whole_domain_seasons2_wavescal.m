...
if readdata
	 ...
	 if loadwave==1
		 ...
		 save('wave_2023_tmp2_wavescale.mat','waveorb','-mat','-v7.3');
	 else
		 load('wave_2023_tmp2_wavescale.mat');
	 end
     ...
     save('processed_2023_tmp2_wavescale.mat','sal','temp','vt','Lper','waveorbF','-mat','-v7.3');
else
     load('processed_2023_tmp2_wavescale.mat');
end
...
img_name ='HSI_map_Apr-Jun2023_wavescale.png';
saveas(gcf,img_name);
