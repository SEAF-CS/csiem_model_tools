...
if readdata
	 ...
	 if loadwave==1
		 ...
		 save('wave_2023_tmp3.mat','waveorb','-mat','-v7.3');
	 else
		 load('wave_2023_tmp3.mat');
	 end
     ...
     save('processed_2023_tmp3.mat','sal','temp','vt','Lper','waveorbF','-mat','-v7.3');
else
     load('processed_2023_tmp3.mat');
end
...
img_name ='HSI_map_Jul-Sep2023.png';
saveas(gcf,img_name);
