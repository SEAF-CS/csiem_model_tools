...
file='W:\csiem\Model\WAVES\2023_addition\his_20230101.nc';
lon=ncread(file, 'lon');
lat=ncread(file, 'lat');
...
inDir='W:\csiem\Model\WAVES\WAVES\2023_addition\';
...
for t=t1:t2
    ...
    if t==t1
        ...
        output.ubot(:,l1+1:l1+l2)=ubot;
        output.orb(:,l1+1:l1+l2)=orb;
    end

end

save('orbital_2023.mat','output','-mat','-v6');