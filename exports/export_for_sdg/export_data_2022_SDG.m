...
ncfile(1).name='W:\csiem\Model\TFV\csiem_model_tfvaed_1.1\outputs\results\tests_PH_map_light2_OASIM_restart_08_newBIN20240916_SALCH4_WQ.nc'
%'W:\csiem\Model\TFV\Results_2022_B009\csiem_v1_B009_20220101_20221231_WQ_WQ.nc';
...
save('extracted_for_Dan_DOC_2022_SALCH4.mat','output','-mat','-v7.3');

else
    load extracted_for_Dan_DOC_2022_SALCH4.mat;
end
