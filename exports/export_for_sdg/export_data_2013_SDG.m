...
ncfile(1).name='W:\csiem\Model\TFV\Results_2013_B009\csiem_v1_B009_20130101_20131231_WQ_WQ.nc';
...
save('extracted_for_Dan_2013.mat','output','-mat','-v7.3');

else
    load extracted_for_Dan_2013.mat;
end
