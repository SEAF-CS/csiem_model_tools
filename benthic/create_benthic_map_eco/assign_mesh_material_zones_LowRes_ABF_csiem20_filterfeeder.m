...
ncfile="W:\csiem\model\csiem_model_tfvaed_1.6\outputs\results\csiem_B009_20221101_20240401_WQ.nc";
...
img_name =[outDir,'GridB_Material_zones.png'];
saveas(gcf,img_name);
...
zones=  [1, 61, 68,  90,    91,    92,    93];
biomass=[100, 100, 2778, 63955, 27967, 27967, 27967];
...
img_name =[outDir,'GridB_biomass_withreef.png'];
saveas(gcf,img_name);
...
% 
% fclose(fileID);
outfile=[outDir,'csiem_aed_benthic_map_B009_csiem20_filterfeeder_withreef.csv'];
T = table((1:length(Biomass))', Biomass, 'VariableNames', {'ID','BIV_susfeeder'});
