...
shpFile='W:\csiem\Model\TFV\csiem_model_tfvaed_2.0\gis_repo\2_benthic\materials\CSOA_Ranae_SGspp_merged_reorder.shp';
...
img_name =[outDir,'HighRes_Material_zones.png'];
saveas(gcf,img_name);
...
patFig = patch('faces',faces,'vertices',vert,'FaceVertexCData',MPBids);shading flat;
axis equal;
colorbar;

img_name =[outDir,'HighRes_MPB.png'];
saveas(gcf,img_name);
...
%%
outfile=[outDir,'csiem_aed_benthic_map_C001_csiem20_MPB.csv'];
fileID = fopen(outfile,'w');
