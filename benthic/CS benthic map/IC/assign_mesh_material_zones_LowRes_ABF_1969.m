...
Biomass=zeros(length(Depth), 1);  % allocate biomass array
...
totalBiomass(totalBiomass<3000 & totalBiomass>0)=3000;
% 
...
%%
outfile='csiem_aed_benthic_map_A001_history1969.csv';
fileID = fopen(outfile,'w');
