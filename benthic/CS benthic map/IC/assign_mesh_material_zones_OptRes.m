...
ncfile='W:\csiem\Model\TFV\Results_2022_B009\csiem_v1_B009_20220101_20221231_WQ_WQ.nc';
...
outfile='Material_zone_in_Cells_OptRes.csv';
...
img_name ='OptRes_Material_zones.png';
saveas(gcf,img_name);
...
img_name ='OptRes_MAC_allBiomass.jpg';
saveas(gcf,img_name);

%%
outfile='csiem_aed_benthic_map_B009_Jul2024.csv';
fileID = fopen(outfile,'w');
