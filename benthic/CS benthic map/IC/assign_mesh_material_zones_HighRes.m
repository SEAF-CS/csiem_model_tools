...
ncfile='W:\csiem\Model\TFV\csiem_model_tfvaed_1.1\outputs\results_highRes_202204\csiem_v1_C001_20220101_20221231_WQ_highRes.nc';
...
outfile='Material_zone_in_Cells_HighRes.csv';
...
img_name ='HighRes_Material_zones.png';
saveas(gcf,img_name);
...
img_name ='HighRes_MAC_allBiomass.jpg';
saveas(gcf,img_name);

%%
outfile='csiem_aed_benthic_map_C001_Jul2024.csv';
fileID = fopen(outfile,'w');
