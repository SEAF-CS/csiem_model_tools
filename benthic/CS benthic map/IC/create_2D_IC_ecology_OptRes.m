...
optResNc='W:\csiem\Model\TFV\Results_2022_B009\csiem_v1_B009_20220101_20221231_WQ_WQ.nc';

ICf='W:\csiem\Model\TFV\csiem_model_tfvaed_2.0\gis_repo\2_benthic\ecology\csiem_aed_benthic_map_A001_csiem20_MPB.csv';
outfile='.\benthic_ecology_csiem20\csiem_aed_benthic_map_B009_csiem20_MPB.csv';
...
vars={'MAC_seagrass_ag','MAC_seagrass_bg','MAC_seagrass_fr','NCS_fs1','PHY_mpb'};
...
for ii=1:length(xxo)
    ...
    fprintf(fileID,'%6.4f,',outdata.MAC_seagrass_ag(ii));
    fprintf(fileID,'%6.4f,',outdata.MAC_seagrass_bg(ii));
    fprintf(fileID,'%6.4f,',outdata.MAC_seagrass_fr(ii));
...
img_name =['.\benthic_ecology_csiem20\',vars{vv},'.png'];
saveas(gcf,img_name);
