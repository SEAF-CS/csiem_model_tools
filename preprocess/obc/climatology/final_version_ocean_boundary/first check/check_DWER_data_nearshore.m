...
%             end
    ...
    save('processed_DWER_udates.mat','dataout','datasum','-mat','-v7.3');

else
    load processed_DWER_udates.mat;
end
...
img_name ='check_DWER_boxplot.png';
...
img_name ='check_DWER_boxchat.png';
