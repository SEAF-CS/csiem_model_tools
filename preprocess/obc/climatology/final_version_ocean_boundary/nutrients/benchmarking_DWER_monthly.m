...
for v=1:length(vars)
    subplot(3,2,v);
    scatter(IMOS.dataout.(vars{v}).Date,IMOS.dataout.(vars{v}).Data,ms,'k','filled','MarkerFaceAlpha',.6,'MarkerEdgeAlpha',.6,'DisplayName','DWER');
    hold on;
...
%     else
    ...
    plot(output.time,output.data,'Color',[1 0 1 0.2],'DisplayName','monthly');
    hold on;
    end
