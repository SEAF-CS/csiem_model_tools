...
vars={'WQ_PHS_FRP','WQ_NIT_AMM','WQ_NIT_NIT','WQ_OXY_OXY','TSSinorganic','TSSorganic','WQ_DIAG_PHY_TCHLA'};
titles={'FRP','AMM','NIT','DO','TSS inorganic','TSS organic','TCHLA'};
units={'\muM','\muM','\muM','\muM','mg/L','mg/L','\mug/L'};

IMOS.dataout.TSSinorganic.Data(IMOS.dataout.TSSinorganic.Data>2)=1;
...
for v=1:length(vars)
    subplot(4,2,v);
    scatter(IMOS.dataout.(vars{v}).Date,IMOS.dataout.(vars{v}).Data,ms,'filled','MarkerFaceColor',colors(1,:),'MarkerEdgeAlpha',.6,'DisplayName','IMOS');
    hold on;
    timearray=IMOS.dataout.(vars{v}).Date;
    rawdata=IMOS.dataout.(vars{v}).Data;
    [output] = create_monthly_climatology(timearray, rawdata);
        
    %scatter(output.time,output.data,ms,'m','filled','MarkerFaceAlpha',.2,'MarkerEdgeAlpha',.2,'DisplayName','monthly');
    ...
    title(titles{v});
    if v==1
        scatter(MOI.csiem.MOI_PISCES_Polygon_3.WQ_PHS_FRP.Date,MOI.csiem.MOI_PISCES_Polygon_3.WQ_PHS_FRP.Data,ms,'filled','MarkerFaceColor',colors(2,:),'MarkerFaceAlpha',.2,'MarkerEdgeAlpha',.2,'DisplayName','PISCES');
        hold on;
    ...
    elseif v==2
        ...
        % set(hl,'Location','eastoutside');    
    elseif v==3
        scatter(MOI.csiem.MOI_PISCES_Polygon_3.WQ_NIT_NIT.Date,MOI.csiem.MOI_PISCES_Polygon_3.WQ_NIT_NIT.Data,ms,'filled','MarkerFaceColor',colors(2,:),'MarkerFaceAlpha',.2,'MarkerEdgeAlpha',.2,'DisplayName','PISCES');
        ylim([0 1]);
        hold on;
        hl=legend; 
        % set(hl,'Location','eastoutside');    
    elseif v==4
        scatter(MOI.csiem.MOI_PISCES_Polygon_3.WQ_OXY_OXY.Date,MOI.csiem.MOI_PISCES_Polygon_3.WQ_OXY_OXY.Data,ms,'filled','MarkerFaceColor',colors(2,:),'MarkerFaceAlpha',.2,'MarkerEdgeAlpha',.2,'DisplayName','PISCES');
        ylim([180 300]);
        hold on;
        hl=legend; 
...
%         % set(hl,'Location','eastoutside');
    ...
    elseif v==6
        ...
        % set(hl,'Location','eastoutside');
    elseif v==7
        scatter(ESA.csiem.ESA_SEN_Polygon_3.WQ_DIAG_PHY_TCHLA.Date,ESA.csiem.ESA_SEN_Polygon_3.WQ_DIAG_PHY_TCHLA.Data,ms,'filled','MarkerFaceColor',colors(2,:),'MarkerFaceAlpha',.2,'MarkerEdgeAlpha',.2,'DisplayName','Sentinel');
        ylim([0 5]);
        hold on;
        hl=legend; 
    end
...
img_name ='IMOS_Benchmarking_timeseries_monthly_final_v2.png';
