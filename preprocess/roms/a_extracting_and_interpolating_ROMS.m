...
%% User input for a
resdir = '/Projects2/WAMSI/Model/ROMS/2021/';
...
%zlim = [0 5000];
tstart  = datenum(2021,01,01); % starting time of download
tfinish  = datenum(2021,12,31); % end time of download
...
jobno = '11348'; % For file metadata
 ...
 timezone_Name = 'UTC+8';
 inpat = '/Projects2/WAMSI/Model/ROMS/inputs_2021/';
 outinpat = [inpat 'nc/'];
