...
inDir='W:\csiem\Model\TFV\csiem_model_tfvaed_1.1\bc_repo\7_discharges\BP\';

files=dir([inDir,'BP_20150101_20160101_wq.csv']);
...
for ff=1:length(files)
    ...
    for yy=1980:2024
        tdiff=datenum(2015,1,1)-datenum(yy,1,1);
    ...
    outfile=strrep(infile,'20150101_20160101','19800101_20241231');
    disp(outfile);
