...
inDir='W:\csiem\Model\TFV\csiem_model_tfvaed_1.1\bc_repo\7_discharges\TiWest\';

files=dir([inDir,'TiWest_*20130101_20140101_wq.csv']);
...
for ff=1:length(files)
    ...
    outfile=strrep(infile,'20130101_20140101','1980101_20241231');
    disp(outfile);
