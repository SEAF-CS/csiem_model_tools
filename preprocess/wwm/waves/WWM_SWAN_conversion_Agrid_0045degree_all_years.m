...
for yy=length(years2pro)
    ...
    outfile = ['WWM_SWAN_CONV_Agrid_',years2pro{yy},'.nc'];
    ...
    save(['output_Agrid_',years2pro{yy},'.mat'],'output','-mat','-v7.3');
    clear output;
...
for yy=1:length(years2pro)
    infile=['F:\CockburnSound_BCs\Wave-A\WWM_SWAN_CONV_Agrid_',years2pro{yy},'.nc'];
    disp(infile);
