...
%                                   points
%       variables = {'var1';'var2} cell array with list of variables to extract
%                                  Dont forget layerface_Z
%
% Copyright (C) BMT 2023
%


function fv_create_profiles_vars(varargin)
	varspec=false;
...
%         pause
    ...
    if varspec
    	out = fv_get_profile(infil,cellids,[1 inf],'variable',varpull);
    else
